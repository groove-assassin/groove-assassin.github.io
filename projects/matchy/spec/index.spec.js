...
describe("#functions", function () {
    ...
    describe("Part 2, Step 1: Search", function () {
        it('search() should return animal by name!', function () {
            // console.log('1: animals is ', animals);
            // console.log('1: animals[0]', animals[0]);
            // console.log('1: animals[1]', animals[1]);
            
            const
                nameOne = animals[0].name,
                nameTwo = animals[1].name;
                
                console.log('2: name two is ' + nameTwo);
                console.log('2: animals is ', animals);
